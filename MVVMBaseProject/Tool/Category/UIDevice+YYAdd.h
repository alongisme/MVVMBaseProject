...
#define ALIPhone6 [[UIDevice currentDevice].machineModelName isEqualToString:@"iPhone 6"]
#define ALIPhone6P [[UIDevice currentDevice].machineModelName isEqualToString:@"iPhone 6 Plus"]
#define ALIPhone6S [[UIDevice currentDevice].machineModelName isEqualToString:@"iPhone 6s"]
#define ALIPhone6SP [[UIDevice currentDevice].machineModelName isEqualToString:@"iPhone 6s Plus"]
#define ALIPhone7 [[UIDevice currentDevice].machineModelName isEqualToString:@"iPhone 7"]
#define ALIPhone7P [[UIDevice currentDevice].machineModelName isEqualToString:@"iPhone 7 Plus"]
